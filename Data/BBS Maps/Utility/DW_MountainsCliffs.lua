...
function ApplyTectonics(args, plotTypes)
	...
	-- 705: Added code to help reduce coastal hills too, a side-effect of using the
	-- multilayered fractal's water layer to generate coves & bays
